...
function karelImporter() {
    ...
    * Returns the button
    */
   function createButton(parent, src) {
   ...
   var playButton = createButton(buttonBar, 'images/playButton.png');
   playButton.id = 'playButton';
   addSpace(buttonBar);
   var stopButton = createButton(buttonBar, 'images/stopButton.png');
